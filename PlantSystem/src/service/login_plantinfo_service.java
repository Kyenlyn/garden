...
public class login_plantinfo_service {
	...
	private static void displayPlantSortMenu() {
        Scanner scanner = new Scanner(System.in);
	...
	private static void displayInsertPlant(plant_infoDAO plantDAO, image_infoDAO imageDAO) {
		Scanner scanner = new Scanner(System.in);
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    // 调用查询植物信息的逻辑
				List<PlantDetailView> plantDetailViewList;
				try {
					plantDetailViewList = plantDao.queryAllPf();
					displayQuery(plantDetailViewList);
				} catch (Exception e) {
	...
	private static Map<String, Object> parseUserInput(String userInput) {
	...
	private static void displayDeletePlant(plant_infoDAO plantDAO, image_infoDAO imageDAO, String deleteId)
			throws Exception {
	...
	private static void updateSelect(Scanner scanner, plant_infoDAO plantDAO, PlantInfo plantinfo) throws Exception {
	...
	private static void displayQuery(List<PlantDetailView> plantDetailViewList) {
		try {
